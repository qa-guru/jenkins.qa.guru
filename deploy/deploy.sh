...
install -d "${CONFIG_DIR}/java-jdk21-agent" "${CONFIG_DIR}/java-jdk17-agent" "${CONFIG_DIR}/python-python314-agent" "${CONFIG_DIR}/js-node24-agent" "${CONFIG_DIR}/bin"
...
install -m 644 "${SCRIPT_DIR}/java-jdk17-agent/Dockerfile" "${CONFIG_DIR}/java-jdk17-agent/Dockerfile"
